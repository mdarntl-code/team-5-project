import{i as x,a as w}from"./assets/vendor-CK1Rzdhu.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const H={position:"topRight",timeout:4e3,theme:"dark",backgroundColor:"#060307",progressBarColor:"#4E75FF"},L=(t,e="error")=>{x[e]({...H,title:e==="error"?"Error":"Success",message:t,backgroundColor:e==="error"?"#1a0505":"#060307"})};w.defaults.baseURL="https://sound-wave.b.goit.study/api";async function $(t,e,a={}){var o,s;try{return(await w({method:t,url:e,...a})).data}catch(i){const n=((s=(o=i.response)==null?void 0:o.data)==null?void 0:s.message)||i.message;return L(n),null}}const I=({page:t=1,limit:e})=>$("get","/artists",{params:{page:t,limit:e}}),j=t=>$("get",`/artists/${t}`),Y=new URL("/team-5-project/assets/sprite-Cu7vlAtS.svg",import.meta.url).href,D=document.querySelector(".artists-list");function S(t){const e=t.map(({_id:a,strArtist:o,strArtistThumb:s,genres:i,strBiographyEN:n})=>{const c=i.map(l=>`<span class="artist-genre">${l}</span>`).join("");return`
    ...
    </div>`).join("")}function R({artist:t,yearsActive:e,specificInfoMarkup:a,albumsMarkup:o}){const{strArtist:s,strArtistThumb:i,strCountry:n,strBiographyEN:c,genres:l}=t;return`
